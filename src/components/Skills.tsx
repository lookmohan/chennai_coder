      ...
      <div className="container">
        ...
        <div className="section-header">
          ...
          <p className="section-desc">
            Technologies, frameworks, and tools used for building AI applications, software solutions, and technical training.
          </p>
        </div>
          ...
          {filteredCategories.map((category) => (
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                ...
                <h3 style={{ fontSize: '1.2rem', color: 'var(--text-heading)', fontWeight: 700, margin: 0 }}>
                  {category.title}
                </h3>
              </div>
